...
import './Update_Saving_Transition.scss';
import Dark_Div from '../../../../Components/Dark_Div/Dark_Div';
import Global_Button from '../../../../Components/Buttons/Global_Button/Global_Button';
import { useTranslation } from 'react-i18next';
import useUpdateSavingTransition from '../../../../Hooks/Saving_Transitions/useUpdateSavingTransition';
...
const Update_Saving_Transition = ({ openForm, setOpenForm, selectedTransition }) => {
  ...
  } = useUpdateSavingTransition(selectedTransition)
  ...
  useEffect(() => {
    if (selectedTransition) {
      setDate(formatDateTimeLocal(selectedTransition.date));
      setAmount(selectedTransition.amount);
      setPlatformID(selectedTransition.platformID);
      setCurrencyTypeID(selectedTransition.currencyTypeID);
      setTransitionType(selectedTransition.transitionType);
      setDescription(selectedTransition.description);
      setFeesPaid(selectedTransition.feesPaid);
      setPlatformName(selectedTransition.platform);
      setPlatformImage(selectedTransition.platformIMG);
      setCurrencyCode(selectedTransition.currencyCode)
    }
  }, [selectedTransition]);
  ...
  return (
    <>
      ...
      <div className={`Update_Saving_Transition ${openForm ? 'active' : ''}`}>
        {step === 1 && (
        ...
        {step === 3 && (
          <form>
            ...
            <div className='Button_Field'>
              <Global_Button 
                Text={t("Update transition")}
                onClick={updateSavingTransition}
              />
            </div>
          </form>
        )}
...
export default Update_Saving_Transition;